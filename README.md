...
- [Game Boy Mini Camera](https://github.com/gameboycamera/game-boy-mini-camera) by gameboycamera (mini size board) and custom [stickers](https://github.com/supertazon/Game-Boy-Mini-Camera-Famicom-styled-label). This project is a miniaturization of this [one](https://github.com/HDR/Gameboy-Camera-Flashcart).
...
**Warning: public Discord servers are out of control. I recommend contributing only if you know the moderators in person.**
