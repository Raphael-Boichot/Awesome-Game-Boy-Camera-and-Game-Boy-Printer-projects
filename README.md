...
- The [Retrospy Pixel](https://retro-spy.com/product/pixel-gameboy-printer/) is just a shameless copy of the previous project sold with a very dull decoder. Building intructions to not buy this scam are just a [fucking joke](https://retro-spy.com/wiki/gameboy-printer-emulation-on-arduino-getting-started/) adding confusion instead of giving any help. Decoders made for the previous Arduino project are of course 100% intercompatible (this is the same device !), so just move along.
