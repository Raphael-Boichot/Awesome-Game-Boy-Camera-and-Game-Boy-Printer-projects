...
- [Flashable Game Boy Camera](https://github.com/HDR/Gameboy-Camera-Flashcart), the first published project (regular board), coming with its childish [Wall of Shame](https://github.com/HDR/Licence-Violation-Hall-Of-Shame) and [defamation tweets](https://x.com/MartinRefseth/status/1736793436664049988), if you dare diminishing the return on investment of the project.
