...
- **Are listed:** projects with a proof that they did something and/or with a very minimal level of explanation, commercial devices because they can be dismantled to look inside.
- **Are not listed:** non primary sources (citations of citations with nothing original, typically A.I. generated slop). Undocumented enough / unintelligible projects because README.md is not here for decoration and I'm not in your brain. Projects / items that cannot be reproduced / bought. Reddit / X posts as they have near zero technical value.

Some projets are probably yet listed in the [awesome-gbdev project](https://github.com/gbdev/awesome-gbdev) or some other cryptic listing but I don't care. I'm not affiliated with any online retro community. I'm maintaining this list updated for my own satisfaction only. Consider that I'm definitely bored with this niche topic when updates cease.
...
# Game Boy Camera
## Flashable Cameras
- [Flashable Game Boy Camera](https://github.com/2BitWizard/GB_Mini_Camera) by 2BitWizard (mini size board) and a [comprehensive fork](https://github.com/Raphael-Boichot/GB_Mini_Camera) by Raphael-Boichot. This project is license free and compatible with the [Camera +](https://ko-fi.com/s/9457d1cc6e) and [Camera + Mini](https://ko-fi.com/s/a4d7bd649a) shells. Current version is 2.0 in the main project (dual ROM bank), 1.4 in the fork (single ROM bank).
...
## FRAM mod
- [FRAM camera mod](https://gbdev.gg8.se/forums/viewtopic.php?id=843) by famiac. Honestly, never saw any existing unit but why not. I anyway advise increasing the 22 pF caps to at least 33 pF.
...
- The [Retrospy Pixel](https://retro-spy.com/product/pixel-gameboy-printer/) is just an Arduino nano flashed with the same code as the previous project and sold with a dull proprietary decoder. Just move along and [build your own](https://github.com/Raphael-Boichot/Collection-of-PCB-for-Game-Boy-Printer-Emulators) for cheap, it's easy.
