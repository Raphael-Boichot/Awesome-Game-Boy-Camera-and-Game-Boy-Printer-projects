...
- This other [Python/Cython code](https://github.com/sudo-Eric/gameboy-thermal-receipt-printer) by sudo-Eric aims to directly target a receipt printer target (project in dev).
