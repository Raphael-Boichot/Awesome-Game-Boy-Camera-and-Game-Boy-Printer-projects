...
- [Game Boy Mini Camera](https://github.com/gameboycamera/game-boy-mini-camera) by gameboycamera (mini size board) and custom [stickers](https://github.com/supertazon/Game-Boy-Mini-Camera-Famicom-styled-label). This is an adaptation of this early [project](https://github.com/HDR/Gameboy-Camera-Flashcart).
...
## Printer emulators
- The [Arduino Game Boy Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) by mofosyne, the most versatile emulator, supporting the 110 games compatible with the printer. Many open source decoders available, see next.
- The [Retrospy Pixel](https://retro-spy.com/product/pixel-gameboy-printer/) is just a shameless copy of the previous project sold with a very dull decoder. Building intructions to not buy this scam are just a [fucking joke](https://retro-spy.com/wiki/gameboy-printer-emulation-on-arduino-getting-started/) adding confusion instead of giving any help. Decoder made for the previous project are of course off course 100% intercompatible (this is the same device), so just move along.
