...
- A [Game Boy Printer test rom](https://github.com/mmuszkow/gbprinter) by mmuszkow, without much information, but which cannot work on real printer due to an error in protocol.
