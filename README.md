...
**Warning: public Discord servers are infamous for being packed with mentally disordered people and vicious moderators (or the inverse).** The bigger the server, the more it is out of control. There is no easy way for a user to cleanly disappear from the platform in case of trouble. Moderators (and mini mods, their minions) have totally disproportionate rights over you. My advise: **contribute in a Discord server ONLY if you know the moderators in person or just watch the dramas from afar without contributing.**
