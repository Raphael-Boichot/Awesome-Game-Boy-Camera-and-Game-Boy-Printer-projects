...
- [Game Boy Mini Camera](https://github.com/gameboycamera/game-boy-mini-camera) (Mini board), redesigned into the size of a typical Game Boy Cart and [stickers](https://github.com/supertazon/Game-Boy-Mini-Camera-Famicom-styled-label) going with it. The project is covered by a very rare Schrodinger's license which is [non commercial](https://github.com/gameboycamera/game-boy-mini-camera/blob/main/license) and [commercial ](https://ko-fi.com/s/5a678033de) depending on the observer.
- [Flashable Game Boy Camera](https://github.com/HDR/Gameboy-Camera-Flashcart), the first published project (regular board), coming with its childish [Wall of Shame](https://github.com/HDR/Licence-Violation-Hall-Of-Shame) and [defamation tweets](https://x.com/MartinRefseth/status/1736793436664049988), if you dare understanding the license.
