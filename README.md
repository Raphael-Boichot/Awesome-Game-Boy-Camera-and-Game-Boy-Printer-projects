...
- **Are listed:** projects with a proof that they did something and/or with a sufficient level of explanation (and I'm very tolerant). Commercial devices are of course part of the game because it's also about making juicy money. Projects issued by people that I consider as pure creeps are of course listed, awesome projects are not always made by awesome people.
...
- [Game Boy Mini Camera](https://github.com/gameboycamera/game-boy-mini-camera) (Mini board), redesigned into the size of a typical Game Boy Cart and [stickers](https://github.com/supertazon/Game-Boy-Mini-Camera-Famicom-styled-label) going with it. The project is issued with a very rare Schrödinger's license which is [non commercial](https://github.com/gameboycamera/game-boy-mini-camera/blob/main/license) and [commercial ](https://ko-fi.com/s/5a678033de) at the same time.
- [Flashable Game Boy Camera](https://github.com/HDR/Gameboy-Camera-Flashcart), the first published project (regular board), coming with its childish [Wall of Shame](https://github.com/HDR/Licence-Violation-Hall-Of-Shame) and [defamation tweets](https://x.com/MartinRefseth/status/1736793436664049988), if you dare having an impact on the money return from the project.
...
## Emulators
- The [Arduino Game Boy Printer emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator), the most versatile emulator, supporting the 110 games compatible with the printer. The [Retrospy Pixel](https://retro-spy.com/product/pixel-gameboy-printer/) is just a shameless copy with a laughable image converter.
