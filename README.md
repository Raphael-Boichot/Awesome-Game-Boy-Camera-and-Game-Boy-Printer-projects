...
- [Flashable Game Boy Camera](https://github.com/HDR/Gameboy-Camera-Flashcart) by HDR, the first published project (regular board), coming with it's childish [Wall of Shame](https://github.com/HDR/Licence-Violation-Hall-Of-Shame) and [defamation tweets]() if you dare applying _stricto sensu_ the license that the author himself does not understand.
