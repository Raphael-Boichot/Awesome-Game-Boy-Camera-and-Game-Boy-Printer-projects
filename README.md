...
- The [first project of flashable camera](https://github.com/HDR/Gameboy-Camera-Flashcart) (regular size board) that I do not recommend crafting unless you want to sponsor and/or give credit to a [scumbag](https://github.com/HDR/Licence-Violation-Hall-Of-Shame).
