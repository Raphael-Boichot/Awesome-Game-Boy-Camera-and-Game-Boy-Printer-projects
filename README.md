...
**Gentle reminder:** disappearing from Discord platform is a [real pain in the arse](https://github.com/victornpb/undiscord) and mods themselves have by default a disproportionate control over your data, whatever the platform, even not considering they could be mentally sick. To be safe, consider that you do not have any ownership on everything you write on any social media.
