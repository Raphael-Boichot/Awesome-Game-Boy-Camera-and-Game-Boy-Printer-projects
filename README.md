...
- The [first project of flashable camera](https://github.com/HDR/Gameboy-Camera-Flashcart) that I do not recommend crafting unless you want to sponsor its author who is a [notorious scumbag](https://github.com/HDR/Licence-Violation-Hall-Of-Shame).
