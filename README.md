...
**Warning: public Discord servers are famous for being packed with deviant people. They are also privacy nightmares.** There's no easy way for users to mass delete their own messages. Moderators can lock them in read-only mode or ban you and cut off any access. Deleting your account does not change anything. Consider that **you loose any right with anything you publish there**. My advise: jump in a Discord server **ONLY** only if you know the moderators in real life.
