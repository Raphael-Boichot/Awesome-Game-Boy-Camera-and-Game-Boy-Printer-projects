...
**Warning: public Discord servers are famous for being saturated with sick people. They are also privacy nightmares.** There's no easy way for users to mass delete their own messages. Moderators can lock them in read-only mode or ban you and cut off any access. Deleting your account does not change anything. My advise: **jump in a Discord server ONLY if you can physically reach the moderators / users to break their knees and make them "uncomfortable" for real... if necassary.**
